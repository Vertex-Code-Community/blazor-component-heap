...
namespace Bch.Components.WYSIWYG.Components.Toolbar.LinkInsert;

public partial class BchEditorLinkInsert : IDisposable
{
    ...
    private DotNetObjectReference<BchEditorLinkInsert> _dotNetRef = null!;
